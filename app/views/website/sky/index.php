...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                ...
                <img src="<?= URL."/website/sky/"; ?>img/prdouct/logo.webp" alt=""></a>
                ...
                <div class="item">
                    <div class="row">
                        ...
                        <div class="col-lg-5 d-none d-lg-block">
                            <img src="<?= URL."/website/sky/"; ?>img/prdouct/banner_img.webp" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-7 col-sm-6">
                    <div class="product-item">
                        ...
                        <img src="<?= URL."/website/sky/"; ?>img/feature/feature_1.webp" class="img-fluid" alt="">
                ...
                <div class="col-md-5 col-sm-6">
                    <div class="product-item">
                        ...
                        <img src="<?= URL."/website/sky/"; ?>img/feature/feature_2.webp" class="img-fluid" alt="">
                        <div class="link-product"><a href="#">EXPLORE NOW<i class="fas fa-caret-right"></i> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5 col-sm-6">
                    <div class="product-item">
                        ...
                        <img src="<?= URL."/website/sky/"; ?>img/feature/feature_3.webp" class="img-fluid" alt="">
                        <div class="link-product"><a href="#">EXPLORE NOW<i class="fas fa-caret-right"></i> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-7 col-sm-6">
                    <div class="product-item">
                        ...
                        <img src="<?= URL."/website/sky/"; ?>img/feature/feature_4.webp" class="img-fluid" alt="">
                        <div class="link-product"><a href="#">EXPLORE NOW<i class="fas fa-caret-right"></i> </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="carousel-item active">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_1.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_2.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                                        <h3>Quartz Belt Watch</h3>
                                        <p>$150.00</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_3.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                                        <h3>Quartz Belt Watch</h3>
                                        <p>$150.00</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_4.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                                        <h3>Quartz Belt Watch</h3>
                                        <p>$150.00</p>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_5.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                                        <h3>Quartz Belt Watch</h3>
                                        <p>$150.00</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_7.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                                        <h3>Quartz Belt Watch</h3>
                                        <p>$150.00</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="item">
                                    <img src="<?= URL."/website/sky/"; ?>img/products/product_8.webp" class="img-fluid"
                                        alt="">
                                    <div class="dec">
                                        <h3>Quartz Belt Watch</h3>
                                        <p>$150.00</p>
    ...
    <section id="Sale" class="sale">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="item">
                        <img src="<?= URL."/website/sky/"; ?>img/prdouct/offer_img.webp" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="item">
    ...
    <section class="client-logo">
        <div class="container">
            <div class="client">
                <div class="item">
                    <img src="<?= URL."/website/sky/"; ?>img/client_logo/client_logo_1.webp" alt="">
                </div>
                <div class="item">
                    <img src="<?= URL."/website/sky/"; ?>img/client_logo/client_logo_2.webp" alt="">
                </div>
                <div class="item">
                    <img src="<?= URL."/website/sky/"; ?>img/client_logo/client_logo_3.webp" alt="">
                </div>
                <div class="item">
                    <img src="<?= URL."/website/sky/"; ?>img/client_logo/client_logo_4.webp" alt="">
                </div>
                <div class="item">
                    <img src="<?= URL."/website/sky/"; ?>img/client_logo/client_logo_5.webp" alt="">
                </div>
