...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="<?= URL."/category/index";?>" class="brand-link">

                <span class="brand-text font-weight-light">CMS <b>ITRAX-ACADEMY</b></span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <!-- <li class="nav-item">
                            <a href="<?= URL."/category/editprofile"; ?>" class=" nav-link">
